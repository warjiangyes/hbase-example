...
import org.example.hbase.monitor.entity.DataNodeInfo;
import org.example.hbase.monitor.entity.HdfsSummary;
...
public class HadoopUtil {
    ...
    public static final String hadoopJmxServerUrl = "http://192.168.128.178:50070";
    ...
    public static List<DataNodeInfo> dataNodeInfoReader(String jsonData) throws IOException {
        ...
        for (Entry<String, Object> node : nodes.entrySet()) {
            ...
            dataNodeInfo.setNodeAddress(info.get("infoAddr").toString().split(":")[0]);
            ...
            dataNodeInfo.setBlockPoolUsedParent(doubleFormat(info.get("blockPoolUsedPercent")));
